    ...
    if (role === "client") {
      ...
      query = `
        SELECT 
          ...
          ur.evidence_image,
          ur.date_reported,
          cl.clinic_name AS reported_user_name,
          cl2.clinic_name AS reporter_user_name
        FROM user_reports ur
        JOIN users u1 ON ur.reported_user_id = u1.user_id
        JOIN clinics cl ON u1.user_id = cl.owner_id
        JOIN users u2 ON ur.reporter_user_id = u2.user_id
        JOIN clinics cl2 ON u2.user_id = cl2.owner_id
